...
export type GetContractQuery = { __typename?: 'query_root', Contracts: Array<{ __typename?: 'Contracts', abi: any, bytecode: string }> };
...
export type GetAgreementExtensionByIdQueryVariables = Exact<{
  id: Scalars['uuid'];
}>;
